...
class JsonMinifyScreen extends ConsumerStatefulWidget {
  const JsonMinifyScreen({super.key});
  @override
  ConsumerState<JsonMinifyScreen> createState() => _State();
}

class _State extends ConsumerState<JsonMinifyScreen> {
  ...
  Widget build(BuildContext context) {
    return ToolPageScaffold(
      toolId: 'text_json_minify',
      titleKey: 'text_json_minify',
      child: Column(
        ...
        children: [
          ...
          FilledButton(onPressed: _minify, child: const Text('压缩')),
          if (_error != null) ...[
            const SizedBox(height: 12),
